...
A permalink is a model and object id encoded into a URL.  It allows the model
to change its absolute URL without breaking links.
'''
...
def create(obj):
    ...
    kwargs = {'content_type_id': content_type_id,
              'object_id': object_id}
    return urls.reverse('permalink_redirect', kwargs=kwargs)
