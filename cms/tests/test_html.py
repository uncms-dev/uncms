...
from cms.html import clean_all, clean_html, process_html
...
def test_html_clean():
    ...
    with override_settings(UNCMS={'HTML_CLEANERS': ['cms.html.clean_html', 'cms.tests.test_html.example_processor']}):
